...
###################### DATENBANK ENTRIES UND INDEX DICT ERSTELLEN  ###################
        ...
        connect = sqlite3.connect('ilias_formelfrage_permutation_db.db')
...
###################### "Formelfrage-Datenbank" - FRAME   -------- LABELS / ENTRYS / BUTTONS  ###################
        ...
        self.ffperm_database_show_db_formelfrage_permutation_btn = Button(self.ffperm_frame_database, text="FFperm - Datenbank anzeigen", command=lambda: test_generator_modul_datenbanken_anzeigen.MainGUI.__init__(self, "ilias_formelfrage_permutation_db", "formelfrage_permutation_table"))
...
###################### "Excel Import/Export" - FRAME   -------- LABELS / ENTRYS / BUTTONS  ###################
        ...
        # excel_export_btn
        self.ffperm_excel_export_to_xlsx_formelfrage_permutation_btn = Button(self.ffperm_frame_excel_import_export, text="Datenbank exportieren",command=lambda: test_generator_modul_datenbanken_erstellen.Import_Export_Database.excel_export_to_xlsx(self, self.project_root_path, self.ffperm_db_entry_to_index_dict, "ilias_formelfrage_permutation_db.db", "formelfrage_permutation_table", "formelfrage_permutation_DB_export_file.xlsx", "Formelfrage - Database"))
...
#############  DATENBANK FUNKTIONEN
    def ffperm_save_id_to_db(self):
        conn = sqlite3.connect('ilias_formelfrage_permutation_db.db')
        c =conn.cursor()
    ...
    def ffperm_delete_id_from_db(self):
        ...
        test_generator_modul_datenbanken_erstellen.Delete_Entry_from_Database.__init__(self, self.ffperm_delete_box_id, "formelfrage", self.ffperm_var_delete_all.get(), self.project_root_path, self.ffperm_db_entry_to_index_dict, "ilias_formelfrage_permutation_db.db", "formelfrage_permutation_table", "formelfrage_permutation_DB_export_file.xlsx", "Formelfrage - Database")
...
class Create_formelfrage_permutation_Questions(Formelfrage_Permutation):
    ...
    def __init__(self, db_entry_to_index_dict, ids_in_entry_box, question_type, pool_img_dir, ilias_id_pool_qpl_dir, xml_read_qti_template_path, xml_qti_output_file_path, xml_qpl_output_file_path, max_id_pool_qti_xml, max_id, taxonomy_file_question_pool):
        ...
        connect_ffperm_db = sqlite3.connect('ilias_formelfrage_permutation_db.db')
    ...
    def ffperm_question_structure(self, id_nr):
        ...
        ffperm_connect = sqlite3.connect('ilias_formelfrage_permutation_db.db')
...
class Create_formelfrage_permutation_Pool(Formelfrage_Permutation):
    ...
    def __init__(self, entry_to_index_dict, var_create_all_questions):
        ...
        test_generator_modul_ilias_test_struktur.Create_ILIAS_Pool.__init__(self,
                                                                            ...
                                                                            self.ffperm_question_type_entry.get(),
                                                                            "ilias_formelfrage_permutation_db.db",
