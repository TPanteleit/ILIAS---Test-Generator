...
class CreateDatabases:
    ...
    def __init__(self, project_root_path):
        ...
        self.database_formelfrage_exists = os.path.exists(os.path.normpath(os.path.join(self.project_root_path, "ilias_formelfrage_db.db")))
        self.database_formelfrage_permutation_exists = os.path.exists(os.path.normpath(os.path.join(self.project_root_path, "ilias_formelfrage_permutation_db.db")))
        ...
        self.database_multiplechoice_exists = os.path.exists(os.path.normpath(os.path.join(self.project_root_path, "ilias_multiplechoice_db.db")))
        self.database_zuordnungsfrage_exists = os.path.exists(os.path.normpath(os.path.join(self.project_root_path, "ilias_zuordnungsfrage_db.db")))
...
class Import_Export_Database:
    ...
    def excel_export_to_xlsx(self,  project_root_path, db_entry_to_index_dict, database_name, database_table_name, xlsx_workbook_name, xlsx_worksheet_name):
        ...
        excel = xlsxwriter.Workbook(os.path.normpath(os.path.join(self.project_root_path, "Database_export", self.xlsx_workbook_name)))
            ...
            for column_data in row:
                ...
                if isinstance(column_data, byteobj.ByteString) == True:
                    ...
                    if row[self.db_entry_to_index_dict['description_img_data_' + str(self.picture_index)]] != "EMPTY":
                        with open(os.path.normpath(os.path.join(self.project_root_path, "Database_export", "image_files", self.database_dir_name,  str(row[self.db_entry_to_index_dict['description_img_name_' + str(self.picture_index)]]) + '.png')), 'wb') as image_file:
