...
#    In der derzeitigen Version (v1.3) wird sich auf die Erstellung von Formelfragen beschränkt     #
#                                                                                                   #
#    Excel <-> SQL  Import/Export Funktion hinzugefügt                                              #
#                                                                                                   #
#                                                                                                   #
#####################################################################################################
...
class GuiMainWindow:
    ...
    def __init__(self, master):
        ...
        master.title('ilias - Test-Generator v1.3')
        ...
        self.frame_excel_sql.grid(row=10, column=0, padx=215, pady=10, sticky=NW)
        ...
        # excel_export_btn
        self.excel_xlsx_export_btn = Button(self.frame_excel_sql, text="Export to Excel file",command=lambda: Database.sql_db_to_excel_export(self))
...
class Database(Formelfrage):
    ...
    def submit(self):
        ...
        print(self.myCombo.get())
        print(self.myCombo_res.get())
    ...
    def sql_db_to_excel_export(self):


        table_name = "SQL_DB_export"
        ...
        workbook = xlsxwriter.Workbook(str(pathlib.Path().absolute()) + "/" + table_name + '.xlsx')
            ...
            for record in records:
                if str(record[len(record) - 1]) == self.entry_split[x]:
                    if record[2].lower() == "formelfrage":
                        ...
                        self.question_description_main_italic_end = self.question_description_main_sup.replace('// ', "</i> ")
