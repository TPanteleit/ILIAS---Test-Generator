...
############## DEFINE FREITEXT PATHS
        ...
        self.freitext_files_path_pool_output = os.path.normpath(os.path.join(self.freitext_files_path, "ff_ilias_pool_abgabe"))
        ...
        self.freitext_test_qti_file_path_template = os.path.normpath(os.path.join(self.freitext_files_path, "ff_test_qti_und_tst_dateien_vorlage", "ilias_test_vorlage__qti__.xml"))
        self.freitext_test_tst_file_path_template = os.path.normpath(os.path.join(self.freitext_files_path, "ff_test_qti_und_tst_dateien_vorlage", "ilias_test_vorlage__tst__.xml"))


        # Pfad für ILIAS-Test Dateien (zum hochladen in ILIAS)
        self.freitext_test_qti_file_path_output = os.path.normpath(os.path.join(self.freitext_files_path, "ff_ilias_test_abgabe", "1604407426__0__tst_2040314", "1604407426__0__qti_2040314.xml"))
        self.freitext_test_tst_file_path_output = os.path.normpath(os.path.join(self.freitext_files_path, "ff_ilias_test_abgabe", "1604407426__0__tst_2040314", "1604407426__0__tst_2040314.xml"))
        self.freitext_test_img_file_path = os.path.normpath(os.path.join(self.freitext_files_path, "ff_ilias_test_abgabe", "1604407426__0__tst_2040314", "objects"))


        # Pfad für ILIAS-Pool Vorlage
        self.freitext_pool_qti_file_path_template = os.path.normpath(os.path.join(self.freitext_files_path, "ff_pool_qti_und_qpl_dateien_vorlage", "ilias_pool_vorlage__qti__.xml"))
        self.freitext_pool_qpl_file_path_template = os.path.normpath(os.path.join(self.freitext_files_path, "ff_pool_qti_und_qpl_dateien_vorlage", "ilias_pool_vorlage__qpl__.xml"))
        ...
        self.freitext_pool_directory_output = os.path.normpath(os.path.join(self.freitext_files_path, "ff_ilias_pool_abgabe"))
...
############## FRAMES
        self.ff_frame_ilias_test_title = LabelFrame(self.freitext_tab, text="Testname & Autor", padx=5, pady=5)
        self.ff_frame_ilias_test_title.grid(row=0, column=0, padx=10, pady=10, sticky="NW")

        self.ff_frame = LabelFrame(self.freitext_tab, text="freitext", padx=5, pady=5)
        self.ff_frame.grid(row=1, column=0, padx=10, pady=10, sticky="NW")

        self.ff_frame_question_attributes = LabelFrame(self.freitext_tab, text="Fragen Attribute", padx=5, pady=5)
        self.ff_frame_question_attributes.grid(row=2, column=0, padx=10, pady=10, sticky="NE")

        self.ff_frame_database = LabelFrame(self.freitext_tab, text="Freitext-Datenbank", padx=5, pady=5)
        self.ff_frame_database.grid(row=2, column=0, padx=10, pady=10, sticky="NW")

        self.ff_frame_create_freitext_test = LabelFrame(self.freitext_tab, text="LT-Test erstellen", padx=5, pady=5)
        self.ff_frame_create_freitext_test.grid(row=2, column=0, padx=105, pady=120, sticky="NE")


        self.ff_frame_taxonomy_settings = LabelFrame(self.freitext_tab, text="Taxonomie Einstellungen", padx=5, pady=5)
        self.ff_frame_taxonomy_settings.grid(row=0, column=1, padx=10, pady=10, sticky="NW")

        self.ff_frame_question_description_functions = LabelFrame(self.freitext_tab, text="Fragentext Funktionen", padx=5, pady=5)
        self.ff_frame_question_description_functions.grid(row=1, column=1, padx=10, pady=10, sticky="NW")

        self.ff_frame_excel_import_export = LabelFrame(self.freitext_tab, text="Excel Import/Export", padx=5, pady=5)
        self.ff_frame_excel_import_export.grid(row=2, column=1, padx=10, pady=10, sticky="NW")




        self.ff_frame_description_picture = LabelFrame(self.freitext_tab, text="Fragen-Text Bild", padx=5, pady=5)
...
###################### "Fragen-Text Bild" - FRAME   -------- LABELS / ENTRYS / BUTTONS  ################
        ...
        #self.ff_add_img_to_description_btn = Button(self.ff_frame_question_description_functions, text="Bild hinzufügen", command=lambda: Freitext.lt_add_image_to_description(self, self.ff_var_use_image_1.get(), self.ff_var_use_image_2.get(), self.ff_var_use_image_3.get()))
       # self.ff_add_img_to_description_btn.grid(row=8, column=0, sticky=W, padx = 10, pady=(20,0))
        ...
        #self.ff_remove_img_from_description_btn = Button(self.ff_frame_question_description_functions, text="Bild entfernen", command=lambda: freitext.ff_delete_image_from_description(self, self.ff_var_use_image_1.get(), self.ff_var_use_image_2.get(), self.ff_var_use_image_3.get()))
...
###################### "Fragen Attribute" - FRAME   -------- LABELS / ENTRYS / BUTTONS  ###################
        ...
        self.ff_question_type_entry.insert(0, "Freitext")
...
###################### "FF-Test erstellen" - FRAME   -------- LABELS / ENTRYS / BUTTONS  ###################
        ...
        self.create_freitext_test_btn = Button(self.ff_frame_create_freitext_test, text="FF-Test erstellen", command=lambda: Create_Freitext_Test.__init__(self, self.ff_db_entry_to_index_dict))
        self.create_freitext_test_btn.grid(row=0, column=0, sticky=W)
        self.create_freitext_test_entry = Entry(self.ff_frame_create_freitext_test, width=15)
