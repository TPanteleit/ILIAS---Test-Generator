...
###################### "Excel Import/Export" - FRAME   -------- LABELS / ENTRYS / BUTTONS  ###################
        ...
        # excel_export_btn
        self.sc_excel_export_to_xlsx_singlechoice_btn = Button(self.sc_frame_excel_import_export, text="Datenbank exportieren",command=lambda: test_generator_modul_datenbanken_erstellen.Import_Export_Database.excel_export_to_xlsx(self, self.project_root_path, self.sc_db_entry_to_index_dict, "ilias_singlechoice_db.db", "singlechoice_table", "SingleChoice_DB_export_file.xlsx", "Singlechoice - Database"))
        self.sc_excel_export_to_xlsx_singlechoice_btn.grid(row=1, column=1, sticky=W, pady=5, padx=10)

        # ILIAS_testfile_import
        self.sc_import_ilias_testfile_btn = Button(self.sc_frame_excel_import_export, text="ILIAS-Datei importieren",command=lambda: test_generator_modul_ilias_import_test_datei.Import_ILIAS_Datei_in_DB.__init__(self))
...
# ------------------------------- VARIABLES  - TEXT & ENTRY --------------------------------------------
 ...
 ###################### "SC-Test erstellen" - FRAME   -------- LABELS / ENTRYS / BUTTONS  ###################
    ...
    def sc_delete_id_from_db(self):
        ...
        test_generator_modul_datenbanken_erstellen.Delete_Entry_from_Database.__init__(self, self.sc_delete_box_id, "singlechoice", self.sc_var_delete_all.get(), self.project_root_path, self.sc_db_entry_to_index_dict, "ilias_singlechoice_db.db", "singlechoice_table", "SingleChoice_DB_export_file.xlsx", "Singlechoice - Database")
