...
#    In der derzeitigen Version (v1.6) wird sich auf die Erstellung von Formelfragen beschränkt     #
#                                                                                                   #
#    Unterstützung von Taxonomie Einträgen                                                          #
#                                                                                                   #
# ------------------------------------------------------------------------------------------------- #
...
class GuiMainWindow:
    ...
    def __init__(self, master):
        ...
        master.title('ilias - Test-Generator v1.6')
        ...
        ### Ordner mit steigender ID erstellen
        dir = os.path.normpath(os.path.join(self.project_root_path, '#testnamen'))
        arr = os.listdir(dir)
        print(arr)
        ...
        self.qpl_file_pool_path_write = os.path.normpath(os.path.join(self.project_root_path, "#testnamen", self.ilias_id_pool_qpl, self.ilias_id_pool_qpl_xml))
        self.qti_file_pool_path_write = os.path.normpath(os.path.join(self.project_root_path, "#testnamen", self.ilias_id_pool_qpl, self.ilias_id_pool_qti_xml))


        # Taxonomy - Files
        self.taxonomy_file_read = os.path.normpath(os.path.join(self.project_root_path, "#testnamen", self.ilias_id_pool_qpl, 'Services', 'Taxonomy', 'set_1', 'export.xml'))
        self.taxonomy_file_write = os.path.normpath(os.path.join(self.project_root_path, "#testnamen", self.ilias_id_pool_qpl, 'Services', 'Taxonomy', 'set_1', 'export.xml'))
        ...
        # excel_export_btn
        self.excel_xlsx_export_btn = Button(self.frame_excel_sql, text="Datenbank exportieren",command=lambda: Database.sql_db_to_excel_export(self, self.table_name))
        ...
        self.add_latex_term_btn = Button(self.frame_latex_preview, text="Text \"Latex\"", command=lambda: Formelfrage.add_term(self))
...
class Formelfrage(GuiMainWindow):
    ...
    def add_node_to_tax(self):
        ...
        # Festlegen des 1. EIntrags der Taxonomie

        #self.collect_childs.append("14175")
        #self.collect_title.append(self.tax_root_label)
        #self.collect_depth.append("1")
        #self.collect_parent.append("0")
        #self.collect_order_nr.append("0")
    ...
    def scan_tax_tree(self):
        ...
        self.taxonomy_frame_tree_picture = LabelFrame(self.taxonomy, text="Taxonomie Bild", padx=5, pady=5)
        self.taxonomy_frame_tree_picture.grid(row=0, column=1, padx=20, pady=450, sticky=NW)
        ...
        #print("Root child ID: " + str(min(self.collect_childs)))


        #print("#############################")
        #print(len(self.collect_title))
        #print(len(self.collect_childs))
        #print(len(self.collect_order_nr))
        #print(len(self.collect_depth))
        #print(len(self.collect_parent))
        #print("#############################")
        ...
        #print("##########################")
        #print(self.parentId_from_id_dict)
        #print("##########################")
...
class create_formelfrage_pool(Formelfrage):
    ...
    def __init__(self):
        ...
        createFolder(os.path.normpath(os.path.join(self.project_root_path, "#testnamen", self.ilias_id_pool_qpl)))
        ...
        copytree(os.path.normpath(os.path.join(self.project_root_path, "#testnamen", '1596569820__0__qpl_2074808')),os.path.normpath(os.path.join(self.project_root_path, "#testnamen", self.ilias_id_pool_qpl)))
        os.rename(os.path.normpath(os.path.join(self.project_root_path, "#testnamen",  self.ilias_id_pool_qpl, "1596569820__0__qpl_2074808.xml")),os.path.normpath(os.path.join(self.project_root_path, "#testnamen", self.ilias_id_pool_qpl, self.ilias_id_pool_qpl_xml)))
        os.rename(os.path.normpath(os.path.join(self.project_root_path, "#testnamen", self.ilias_id_pool_qpl, "1596569820__0__qti_2074808.xml")),os.path.normpath(os.path.join(self.project_root_path, "#testnamen", self.ilias_id_pool_qpl, self.ilias_id_pool_qti_xml)))


        ###### Anpassung der Datei "Modul -> export". Akualisierung des Dateinamens
        self.modules_export_file = os.path.normpath(os.path.join(self.project_root_path, "#testnamen", self.ilias_id_pool_qpl, 'Modules', 'TestQuestionPool', 'set_1', 'export.xml'))
        ...
        self.qpl_file = os.path.normpath(os.path.join(self.project_root_path, "#testnamen",  self.ilias_id_pool_qpl, self.ilias_id_pool_qpl_xml))
        ...
        self.taxonomy_export_file = os.path.normpath(os.path.join(self.project_root_path, "#testnamen", self.ilias_id_pool_qpl, 'Services', 'Taxonomy', 'set_1', 'export.xml'))
        ...
        with open(self.taxonomy_export_file, 'r') as xml_file:
           xml_str = xml_file.read()
        xml_str = xml_str.replace('ns0:', 'exp:')
        xml_str = xml_str.replace('ns2:', 'ds:')
        xml_str = xml_str.replace('ns3:', '')#replace "x" with "new value for x"
        ...
        with open(self.taxonomy_export_file, 'w') as replaced_xml_file:
            replaced_xml_file.write(xml_str)
    ...
    def create_question_pool(self, x):
        ...
        for record in records:
            ...
            if str(record[len(record)-1]) == self.entry_split[x]:
                ...
                self.number_of_entrys.append(format(self.id_int_numbers, '06d'))
