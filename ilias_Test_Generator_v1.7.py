...
#    - Bei der Erstellung von Fragenpools werden neue Ordner mit aufsteigender Nummerierung erstellt und    #
#      in "ILIAS-Fragenpool_zum_Import" kopiert.                                                            #
#    - Im Feld "ID Löschen" kann neben "1,2,3,4,5,6" auch "1-6" eingetragen werden                          #
#                                                                                                           #
# -------------------------------------------------------------------------------------------------         #
...
class GuiMainWindow:
    ...
    def __init__(self, master):
        ...
        master.title('ilias - Test-Generator v1.7')
            ...
            for column_data in row:
                ...
                if self.check_if_string_data == false and self.check_if_integer_data == false and self.check_if_float_data == false:
                    ...
                    with open('export_img' + str(row_index) + '.png', 'wb') as image_file:
                        ...
                        excel_sheet.insert_image('ER' + str(row_index+1), str(self.project_root_path) + '/export_img' + str(row_index) + '.png', {'object_position': 2, 'x_scale': x_scale, 'y_scale': y_scale})
