...
class GuiMainWindow:
    ...
    def __init__(self, master):
        ...
        self.project_root_path = r"C:\Users\Genesis\Desktop\ilias Generator - Projekt"
        ...
        self.img_file_path_create_folder = "C:/Users/Genesis/Desktop/ilias Generator - Projekt/1590475954__0__tst_1944463/objects/"
        self.img_file_path = self.project_root_path + r"1590475954__0__tst_1944463\\" + "objects\\"

        # ----  Set size of windows
        # Main-window
        self.formula_width = 600
        self.formula_height = 600

        # Database-window
        self.database_width = 600
        self.database_height = 600

        # Settings-window
        self.settings_width = 600
        self.settings_height = 600
...
class GUI_settings_window(Formelfrage):
    ...
    def create_settings(self):
        ...
        self.mytree = ET.parse('1590475954__0__qti_1944463.xml')
        self.myroot = self.mytree.getroot()

        # need to set ROOT in SubElement
        #assessment = ET.SubElement(self.myroot, 'assessment')
        ...
        #mattext = ET.SubElement(material, 'mattext')
        #mattext.set('texttype', 'text/GZTML')
        #mattext.text = "ZUEZUE"

        # mytree.write('WORKED_neuerAnfang.xml')
        # self.mytree.write("WORKED_neuerAnfang.xml")
        ...
        for qtimetadatafield in self.myroot.iter('qtimetadatafield'):
          ...
          #  if qtimetadatafield.find('fieldlabel').text == "showinfo":
            ...
            if qtimetadatafield.find('fieldlabel').text == "starting_time":
                qtimetadatafield.find('fieldentry').text = "P" + str(self.test_start_year) + "Y" + str(self.test_start_month) + "M" +  str(self.test_start_day) + "DT" + str(self.test_start_hour) + "H" + str(self.test_start_minute) + "M"
            ...
            if qtimetadatafield.find('fieldlabel').text == "ending_time":
                qtimetadatafield.find('fieldentry').text = "P" + str(self.test_end_year) + "Y" + str(self.test_end_month) + "M" +  str(self.test_end_day) + "DT" + str(self.test_end_hour) + "H" + str(self.test_end_minute) + "M"
